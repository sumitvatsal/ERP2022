...
namespace SchoolErp
{
    ...
    public partial class SCHOOLERPEntities : DbContext
    {
        ...
        public virtual DbSet<migpsGpsTrackingSy> migpsGpsTrackingSys { get; set; }
        ...
        public virtual ObjectResult<sp_getAllEmployeeDetailsReports_Result> sp_getAllEmployeeDetailsReports()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<sp_getAllEmployeeDetailsReports_Result>("sp_getAllEmployeeDetailsReports");
        }
